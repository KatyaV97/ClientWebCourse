$(function () {
    ...
    function insertTaskInRow(task, taskRow) {
        taskRow.html("<td class='task'></td>" +
            "<td><button type='button' class='btn btn-outline-success edit-button'>Редактировать</button></td>" +
            "<td><button type='button' class='btn btn-outline-danger delete-button'>Удалить</button></td>")
            .find(".task")
            .text(task);
    ...
    function editTask(task, taskRow) {
        taskRow.html("<td class='edit-task'><input type='text' class='form-control'></td>" +
            "<td><button type='button' class='btn btn-outline-success save-button'>Сохранить</button></td>" +
            "<td><button type='button' class='btn btn-outline-danger cancel-button'>Отмена</button></td>")
